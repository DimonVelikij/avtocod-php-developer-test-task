...
@section('main_content')
    ...
    <div class="container">
        ...
        <form class="form-signin" method="POST" action="{{ route('login-submit') }}" novalidate>
            @if($errors->any())
            ...
            <input type="text" name="email" id="user_login" class="form-control" placeholder="Логин" required autofocus>
            ...
            <div class="checkbox">
                <label>
                    <input type="checkbox" name="remember" value="on" checked> Запомнить меня
                </label>
            </div>
